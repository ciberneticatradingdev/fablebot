// chat-poller.mjs — pump.fun chat + comments for fablebot's coin.
...
const USERNAME = process.env.PUMP_CHAT_USERNAME || "fablebot";
const ME = new Set([USERNAME.toLowerCase(), "fablebot"]);
...
const isHuman = (u) => u && !ME.has(String(u).toLowerCase()) && !String(u).toLowerCase().startsWith("fablebot");
